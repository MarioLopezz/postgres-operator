...
Postgresql Kubernetes Operator based on Operator framework SDK.
...
## Description
The Postgresql Operator manages Postgresql clusters deployed to Kubernetes 
and automates tasks related to operating a Postgresql cluster. It provides 
a full management life-cycle for Postgresql, including deployment, upgrades, 
